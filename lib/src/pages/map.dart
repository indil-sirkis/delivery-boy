          ...
          Positioned(
            ...
            child: Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  launch("http://maps.google.com/maps?saddr=${_con.currentAddress.latitude},${_con.currentAddress.longitude}&daddr=${_con.currentOrder.deliveryAddress.latitude},${_con.currentOrder.deliveryAddress.longitude}");
                },
                child: Icon(
